...
const SearchComponent = () => {
  ...
  const {setProducts,searchTerm,selectedCategory, setSelectedCategory,fetchProducts} = useProductStore();
    ...
    _.debounce( async () => {
      ...
      try {
        ...
        if (selectedSort === "price") {
          ...
          fetchedProducts = fetchedProducts.sort((a, b) => a.discountPercentage - b.discountPercentage);
        } else if (selectedSort === "rating") {
          fetchedProducts = fetchedProducts.sort((a, b) => b.rating - a.rating);
        }
      ...
      {products1.length === 0 && !error && (
        <div className="pb-3 mb-3">
          <video autoPlay loop muted className="empty-cart-video">
            <source src="/src/components/SearchComponent/empty_cart.mp4" type="video/mp4" />
